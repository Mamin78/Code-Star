...
public class RedundantWords {
    public static final ArrayList<String> listOfRedundantWords = new ArrayList<>(Arrays.asList("i", "me", "my", "myself", "we", "our", "ours", "ourselves"
    ...
    public static boolean isRedundantWord(String word) {
        return listOfRedundantWords.contains(word);
    }
}
